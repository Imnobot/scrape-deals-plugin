<?php
// File: includes/shortcode-handler.php (MODIFIED for Instant Load)
...
function dsp_render_shortcode( $atts ) {
    ...
    <div id="dsp-deal-display-container" class="dsp-container">
        ...
        <div class="dsp-status-bar">
            ...
            <span id="dsp-status-message"><?php esc_html_e('Loading initial deals...', 'deal-scraper-plugin'); ?></span>
        ...
        <?php // Donate Modal HTML (remains the same) ?>
        ...
        <?php // Subscribe Modal HTML (remains the same) ?>
        <?php if ($email_enabled) : ?>
